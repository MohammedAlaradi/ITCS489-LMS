...
<div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="sidebarNav" aria-labelledby="sidebarNavLabel">
    ...
    <div class="offcanvas-body">
        <nav class="nav flex-column">
            ...
            <hr>
            <a class="nav-link btn-primary active" href="borrowedBooks.html">Borrowed Books</a>
            <hr>
...
<main class="container mt-4"> 
    <section class="mb-4">
        ...
        <section class="container mt-3">
            ...
            <div id="borrowedCardsRow" class="row g-3">
                <!-- Borrowed book cards will be injected here by borrowedBooksScript.js -->
            </div>
        </section>
