...
<html lang="en">
  <head>
    ...
    <script defer src="borrowedBooksScript.js"></script>
  ...
  <body>
    ...
    <header class="p-3 navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container-fluid d-flex align-items-center">
            <a class="navbar-brand d-flex align-items-center" href="../search/index.php">
                ...
                <span class="ms-2">Borrowed Books</span>
            </a>
        </div>
    </header>

    <!-- SIDEBAR -->
    <div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="sidebarNav">
        <div class="offcanvas-header d-flex justify-content-between align-items-center">
            <h5 class="offcanvas-title mb-0">Navigation</h5>
            <button type="button" class="btn-close ms-2" data-bs-dismiss="offcanvas"></button>
        </div>
        <div class="offcanvas-body">
            <nav class="nav flex-column">
                <a class="nav-link btn-primary" href="../search/index.php">Home</a><hr>
                <a class="nav-link btn-primary active" href="borrowedBooks.php">Borrowed Books</a><hr>
                <a class="nav-link btn-primary" href="../fine/fine.php">Fine</a><hr>
    ...
    <main class="container mt-4">
        ...
        <section class="container mt-3">
            ...
            <div id="borrowedCardsRow" class="row g-3"></div>
        </section>
